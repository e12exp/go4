...
$(EXAMPSIMP_LIB):   $(EXAMPSIMP_O) $(EXAMPSIMP_DO)
	$(MakeLibrary) $(EXAMPSIMP_LIBNAME) "$(EXAMPSIMP_O) $(EXAMPSIMP_DO)" $(EXAMPSIMP_DIR)

$(EXAMPSIMP_DS): $(EXAMPSIMP_H_CINT)  $(EXAMPSIMP_LINKDEF)
	$(ROOTCINTGO4) $(EXAMPSIMP_H_CINT) $(EXAMPSIMP_LINKDEF)
